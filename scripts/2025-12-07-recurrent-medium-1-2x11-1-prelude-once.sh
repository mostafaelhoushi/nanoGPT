...
BATCH_ARGS="--batch_size=4 --gradient_accumulation_steps=40"
...
run_job() {
    ...
    torchrun \
        ...
        --recurrent_shared_num_blocks=2 \
        --recurrent_prelude_injection_first_block_only \
        --recurrent_depth_schedule_min_depth=1 \
        --recurrent_depth_peak=11 \
